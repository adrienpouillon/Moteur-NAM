...
//public
	...
	void App::SetActiveEntity(Scene* scene, const Entity& entity, bool active)
	{
		scene->SetActiveEntity(entity, active);
	}

	void App::SetActiveEntity(u32 idScene, const Entity& entity, bool active)
	{
	...
	GameObject* App::GetGameObject(Scene* scene, const Entity& entity)
	{
	...
	GameObject* App::GetGameObject(u32 idScene, const Entity& entity)
	{
	...
	Scene* App::GetScene(const Entity& entity)
	{
	...
	const float App::GetRealDeltaTime() const
	{
		return m_chrono.GetRealDeltaTime();
	}

	const float App::GetScaledDeltaTime() const
	{
		return m_chrono.GetScaledDeltaTime();
	}*/
