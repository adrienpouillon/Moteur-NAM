...
//#endif
	...
	{
		m_textureManager.CreateTexture(L"../../src/nam_render/Font Sheets/pusab_white.dds", _FontPusab, false);
	...
	void RenderManager::Render3D(ID3D12GraphicsCommandList* p_commandList)
	{
		...
		for (size_t i = 0; i < meshesToDraw.size(); i++)
		{
			...
			p_commandList->SetGraphicsRootDescriptorTable(3, handleTextureIndex);
